...
public class product_cart_payyment extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_cart_payyment);
    ...
    public void onClick(View view) {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                Toast.makeText(product_cart_payyment.this, "Payment Completed", Toast.LENGTH_SHORT).show();
                                Intent ins = new Intent(getApplicationContext(), Home.class);
                                startActivity(ins);
                            }
                            else if(jsonObj.getString("status").equalsIgnoreCase("low")){
                                Toast.makeText(product_cart_payyment.this, "Low Balance", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("total", sh.getString("totalamount",""));
