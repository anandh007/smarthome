...
public class upload_custom_plans extends AppCompatActivity implements View.OnClickListener {
    ImageView iv;
    EditText et1;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_custom_plans);
        iv=(ImageView) findViewById(R.id.planphoto);
        et1=(EditText) findViewById(R.id.description);
...
//                    ed15.setText(fname);
    ...
    public void onClick(View view) {
        ...
        if(view==iv){
            ...
            String url = "http://" + hu + ":5000/and_upload_custom_plan";
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                    Toast.makeText(upload_custom_plans.this, "", Toast.LENGTH_SHORT).show();
